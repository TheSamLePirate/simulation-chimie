...
/**
 * Mounts the imperative {@link SimulationView} into a DOM container and reports
 * engine lifecycle to the parent. Tolerant of React StrictMode's double-mount:
 * any view created during a cancelled mount is disposed immediately.
 */
